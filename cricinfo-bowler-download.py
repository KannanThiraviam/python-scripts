...
base_url = 'https://stats.espncricinfo.com/ci/engine/stats/index.html?class=3;filter=advanced;orderby=start;page={};size=200;template=results;type=bowling;view=innings'
...
def main():
    ...
    if headers:
        ...
        with open('cricinfo-bowling-stats.csv', 'w', newline='', encoding='utf-8') as f:
            writer = csv.writer(f, quoting=csv.QUOTE_MINIMAL)
            writer.writerow(headers)
            writer.writerows(all_data)

        print('Scraping completed and data saved to cricinfo-bowling-stats.csv')
